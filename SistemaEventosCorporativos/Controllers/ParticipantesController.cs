...
namespace SistemaEventosCorporativos.Controllers
{
    public class ParticipantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email")] Participante participante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email")] Participante participante)
        {
